Feature: ログイン
  ...
  Scenario: 未入力でエラーとなること
    Given ホームを開く。
      And ログインペ―ジに移動する。
      And "" ""でログインする。
     Then メールアドレス欄に"このフィールドを入力してください。"と言うエラーが表示されるか確認する。
      And パスワード欄に"このフィールドを入力してください。"と言うエラーが表示されるか確認する。
      And 3秒待つ。
  ...
  Scenario: 未登録のユーザでエラーとなること
    Given ホームを開く。
     ...
     Then メールアドレス欄に"メールアドレスまたはパスワードが違います。"と言うエラーが表示されるか確認する。
      And パスワード欄に"メールアドレスまたはパスワードが違います。"と言うエラーが表示されるか確認する。
